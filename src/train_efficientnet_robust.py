...
Training robust di EfficientNet-B4 per la classificazione
...
from robust_dataloaders import create_robust_dataloaders
...
# Regolarizzazione dell'optimizer.
WEIGHT_DECAY = 1e-4

# Early stopping:
#
# se la validation loss non migliora per 4 epoche
# consecutive, interrompiamo il training.
EARLY_STOPPING_PATIENCE = 4

# Scheduler:
#
# dopo 2 epoche senza miglioramento della validation loss
# dimezziamo il learning rate.
SCHEDULER_PATIENCE = 2
SCHEDULER_FACTOR = 0.5

# Seed utilizzato per rendere gli esperimenti
# il più possibile riproducibili.
RANDOM_SEED = 42
...
HISTORY_PATH = (
    RESULTS_DIR
    / "efficientnet_b4_robust_history.csv"
)
...
def train(
    ...
    """
    Gestisce l'intero training robusto di EfficientNet-B4.
    """
    ...
    print("=" * 70)
    print("TRAINING EFFICIENTNET-B4 ROBUST")
    print("=" * 70)
    ...
    for epoch in range(
        ...
        if (
            ...
            # sovrascrivere il vero modello robust.
            if not smoke_test:
...
def parse_arguments():
    ...
    parser = argparse.ArgumentParser(
        description=(
            "Training robust EfficientNet-B4 "
