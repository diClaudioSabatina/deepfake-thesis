...
Training baseline di EfficientNet-B4 per la classificazione
...
def train(
    ...
    """
    Gestisce l'intero training baseline di EfficientNet-B4.
    """
    ...
    print("=" * 70)
    print("TRAINING EFFICIENTNET-B4 BASELINE")
    print("=" * 70)
...
def parse_arguments():
    ...
    parser = argparse.ArgumentParser(
        description=(
            "Training baseline EfficientNet-B4 "
