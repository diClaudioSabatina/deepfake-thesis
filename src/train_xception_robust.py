...
Training robust di Xception per la classificazione
...
def train(
    ...
    """
    Gestisce l'intero training robust di Xception.
    """
    ...
    print("=" * 70)
    print("TRAINING XCEPTION ROBUST")
    print("=" * 70)
